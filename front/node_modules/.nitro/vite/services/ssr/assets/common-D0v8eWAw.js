import { o as daysAgo, t as cn } from "./utils-DjTi_qin.js";
import { jsx, jsxs } from "react/jsx-runtime";
//#region src/components/common.tsx
var STATUS_STYLE = {
...
function FreshnessDot({ person }) {
	...
	return /* @__PURE__ */ jsxs("span", {
		...
		children: [
			/* @__PURE__ */ jsx("span", { className: cn("size-2 rounded-full", d > 90 ? "bg-danger" : d > 45 ? "bg-warning" : "bg-success") }),
			"обновлено ",
			d,
			" дн. назад"
		]
